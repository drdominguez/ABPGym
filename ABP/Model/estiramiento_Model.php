...
class estiramiento_Model
{
    ...
    function ADD()
    {
        ...
        $sql = "SELECT * FROM estiramiento WHERE idEjercicio= '$this->idEjercicio'";
...
function DELETE()
{
    ...
    {
        $sql = "DELETE FROM estiramiento WHERE idEjercicio= '$this->idEjercicio'";
...
function EDIT()
{
    ...
    if ($result->num_rows == 1)
    {
        $sql = "UPDATE estiramiento SET idEjercicio = '$this->idEjercicio',tiempo = '$this->tiempo',unidad = '$this->unidad',distancia = '$this->distancia' WHERE idEjercicio= '$this->idEjercicio'";
