                ...
                where 
                    ((
                        dni LIKE '%$this->dni%')&&
                         ...
                         (edad LIKE '%$this->edad%')&&
                         (contrasena LIKE '%$this->contrase馻%')&&
...
function EDIT()
{
    ...
    if ($result->num_rows == 1)
    {
        $sql = "UPDATE usuario SET dni = '$this->dni',nombre = '$this->nombre',apellidos = '$this->apellidos',edad = '$this->edad',contrasena = '$this->contrase馻',email = '$this->email',telefono = '$this->telefono',fechaAlta = '$this->fechaAlta' WHERE dni= '$this->dni'";
