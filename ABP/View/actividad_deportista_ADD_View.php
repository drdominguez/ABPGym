...
<?php
     class actividad_deportista_ADD { 
...
?>
            <h1>
            <?php echo $strings['Insertar'] . 'actividad_deportista' ?>
            </h1>        
            <form name = 'Form' action='../Controller/actividad_deportista_Controller.php' method='post' onsubmit='return comprobar_actividad_deportista()'>
