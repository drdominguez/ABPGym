...
<?php
    class notificacion_deportista_EDIT{
        ...
        function render(){
            ...
            include '../Functions/notificacion_deportista_DefForm.php';
       
?>
        
            <h1>
            <?php echo $strings['Modificar'] . 'notificacion_deportista' ?>
            </h1>
                <form name = 'Form' action = 'notificacion_deportista_Controller.php' method = 'post' onsubmit = 'comprobar_notificacion_deportista()'>
        ...
        <?php echo $strings['dniDeportista'] ?> : <input type = 'text' name = 'dniDeportista' size = '10' value ='<?php echo ($this->valores['dniDeportista']); ?>' required  readonly  onblur="esVacio(this)  && comprobarText(this, 10)" ><br>
                ...
                <a href='../Controller/notificacion_deportista_Controller.php'><?php echo $strings['Volver']; ?>
                </a>
