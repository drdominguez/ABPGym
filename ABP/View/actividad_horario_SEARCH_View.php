...
<?php
    ...
    class actividad_horario_SEARCH{
...
?>
            <h1>
            <?php echo $strings['Buscar'] . 'actividad_horario' ?>
            </h1>
            <form name = 'Form' action = 'actividad_horario_Controller.php' method = 'post' onsubmit = 'comprobar()'>
