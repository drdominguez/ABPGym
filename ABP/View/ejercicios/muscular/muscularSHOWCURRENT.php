                ...
                <div class="card mb-3">
                    ...
                    <form name='Form' id="form1" class="form-signin" accept-charset="UTF-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descripcion" rows="2" readonly="readonly"></textarea>
                        </div>
                             </div>
                         </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" name="video" id="exampleInputVideo" readonly="readonly" type="file" aria-describedby="emailHelp" placeholder="Video" onblur="esVacio(this)  && comprobarText(this,15)">
                                 </div>
                                 <div class="col-md-6">
                        ...
                        <div class="form-group">
                             <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="carga" id="exampleInputCarga" type="TEXT" aria-describedby="emailHelp" placeholder="Carga" readonly="readonly" onblur="esVacio(this)  && comprobarText(this,15)">
                                </div>
                                <div class="col-md-6">
                                     <label for="exampleInputCarga">Repeticiones</label>
                                    <input class="form-control" name="repeticiones" id="exampleInputRepeticiones" type="TEXT" aria-describedby="emailHelp" placeholder="Repeticiones" readonly="readonly" onblur="esVacio(this)  && comprobarText(this,15)">
                                </div>
                             </div>
                        </div>
                    </form>
