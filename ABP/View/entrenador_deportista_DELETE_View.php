...
<?php
    class entrenador_deportista_DELETE{ 
        private $valores;
...
?>
            ...
            <form name = 'Form' action = '../Controller/entrenador_deportista_Controller.php' method = 'post' onsubmit = 'comprobar()'>   
        ...
        <?php echo $strings['dniDeportista'] ?> : <input type = 'text' name = 'dniDeportista' size = '10' value ='<?php echo ($this->valores['dniDeportista']); ?>'  readonly  onblur="esVacio(this)  && comprobarText(this, 10)" ><br>
            ...
            <a href='../Controller/entrenador_deportista_Controller.php'><?php echo $strings['Volver']; ?> </a>
<?php
