...
<?php
    class actividad_deportista_EDIT{
...
?>
            ...
            <h1>
            <?php echo $strings['Modificar'] . 'actividad_deportista' ?>
            </h1>
                <form name = 'Form' action = 'actividad_deportista_Controller.php' method = 'post' onsubmit = 'comprobar_actividad_deportista()'>
        ...
        <?php echo $strings['dniDeportista'] ?> : <input type = 'text' name = 'dniDeportista' size = '10' value ='<?php echo ($this->valores['dniDeportista']); ?>' required  readonly  onblur="esVacio(this)  && comprobarText(this, 10)" ><br>
                ...
                <a href='../Controller/actividad_deportista_Controller.php'><?php echo $strings['Volver']; ?>
                </a>
