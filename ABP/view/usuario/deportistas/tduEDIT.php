...
<header>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <form name = 'Form' enctype="multipart/form-data" action='./index.php?controller=Deportista&amp;action=TduEDIT' method='post' onsubmit='return validarTduEDIT()'>
                <div class="card mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type = 'password' onchange="comprobarTexto(this,30)" name = 'contraseña' size = '100' value = ''>
                        </div>
                      </div>
                    </div>
                       <div class="form-group">
