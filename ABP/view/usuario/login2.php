...
<div class="ui-column span6"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><i class="ui--icon icomoon-key icon-inline-block icon-with-background radius-circle" style="font-size: 60px;  width: 64px;  height: 64px;  border-width: 5px;  border-style: solid;"></i></span><div class="ui--icon-box-content"></div></div><h1 id="custom-title-h1-1" class="ui--animation " style="text-align: center; margin-bottom: 0px; "><strong>GymApp</strong></h1>
</div>
...
<form name='Form' action="index.php?controller=Login&amp;action=login"  accept-charset="UTF-8" method="POST" onsubmit="return validarLogin()" class="login-form form-horizontal ui-row">
<div class="form-elements">
<div class="ui-row row">
<p class="control-group">
<label class="control-label ui--animation" for="user_login">Login</label>
<span class="controls ui--animation"><input class="input-text" name="dni" id="exampleInputEmail1" type="TEXT" aria-describedby="emailHelp" placeholder="Introduzca DNI" onchange="comprobarVacio(this)  && comprobarDni(this)"></span>
</p>
<p class="control-group">
<label class="control-label ui--animation" for="user_pass">Password</label>
<span class="controls ui--animation"><input class="input-text" id="exampleInputPassword1" name="contraseña" type="password" placeholder="Password" onchange="comprobarVacio(this)"></span>
</p>
</div>
</div>
