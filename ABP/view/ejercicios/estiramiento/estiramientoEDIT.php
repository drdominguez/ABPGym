    ...
    <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                    <form name='Form' id="form1" class="form-signin" action="index.php?controller=Ejercicio&amp;action=estiramientoEdit" enctype="multipart/form-data" accept-charset="UTF-8" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="nombre" id="exampleInputNombre" type="TEXT" aria-describedby="emailHelp" value="<?php echo $estiramiento->getNombre() ?>" onblur="esVacio(this)  && comprobarText(this,15)">
                            </div>
                            <div class="col-md-6">
