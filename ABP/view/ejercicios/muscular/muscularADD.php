    ...
    <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                    <form name='Form' id="form1" action="index.php?controller=Ejercicio&amp;action=muscularADD" class="form-signin" accept-charset="UTF-8" enctype="multipart/form-data" method="POST">
