                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="nombreRecurso" id="exampleInputNombre" type="text" aria-describedby="emailHelp" value="<?php echo $recurso->getNombreRecurso(); ?>"  onchange="comprobarVacio(this)  && comprobarTexto(this,50)">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
