...
<?php
    class actividad_horario_DELETE{ 
        private $valores;
...
?>
            ...
            <form name = 'Form' action = '../Controller/actividad_horario_Controller.php' method = 'post' onsubmit = 'comprobar()'>   
        ...
        <?php echo $strings['idHorario'] ?> : <input type = 'text' name = 'idHorario' size = '20' value ='<?php echo ($this->valores['idHorario']); ?>'  readonly  onblur="esVacio(this)  && comprobarText(this, 20)" ><br>
            ...
            <a href='../Controller/actividad_horario_Controller.php'><?php echo $strings['Volver']; ?> </a>
<?php
