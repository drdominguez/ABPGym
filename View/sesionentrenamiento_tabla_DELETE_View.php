...
<?php
    class sesionentrenamiento_tabla_DELETE{ 
        private $valores;
...
?>
            ...
            <form name = 'Form' action = '../Controller/sesionentrenamiento_tabla_Controller.php' method = 'post' onsubmit = 'comprobar()'>   
        ...
        <?php echo $strings['idTabla'] ?> : <input type = 'text' name = 'idTabla' size = '20' value ='<?php echo ($this->valores['idTabla']); ?>'  readonly  onblur="esVacio(this)  && comprobarText(this, 20)" ><br>
            ...
            <a href='../Controller/sesionentrenamiento_tabla_Controller.php'><?php echo $strings['Volver']; ?> </a>
<?php
