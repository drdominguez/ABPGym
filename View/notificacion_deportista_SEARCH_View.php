...
<?php
    ...
    class notificacion_deportista_SEARCH{
...
?>
            <h1>
            <?php echo $strings['Buscar'] . 'notificacion_deportista' ?>
            </h1>
            <form name = 'Form' action = 'notificacion_deportista_Controller.php' method = 'post' onsubmit = 'comprobar()'>
