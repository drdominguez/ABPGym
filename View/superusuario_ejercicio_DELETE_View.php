...
<?php
    class superusuario_ejercicio_DELETE{ 
        private $valores;
...
?>
            ...
            <form name = 'Form' action = '../Controller/superusuario_ejercicio_Controller.php' method = 'post' onsubmit = 'comprobar()'>   
        ...
        <?php echo $strings['idEjercicio'] ?> : <input type = 'text' name = 'idEjercicio' size = '20' value ='<?php echo ($this->valores['idEjercicio']); ?>'  readonly  onblur="esVacio(this)  && comprobarText(this, 20)" ><br>
            ...
            <a href='../Controller/superusuario_ejercicio_Controller.php'><?php echo $strings['Volver']; ?> </a>
<?php
